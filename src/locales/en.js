...
const en = {
  nav: {
    ...
    appQuery25: 'Get the list of applications that can be pulled from this warehouse',
  ...
  apppromotion: {
    ...
    appNoticeStatistic: '■ APP notice statistics',
    appHotIndustryDesc: 'Popular industry APP download trends',
    appPushStatisticDesc: 'Top5 App push target appStore statistics chart',
    appNoticeStatisticDesc: 'Top5 App push source appStore statistics chart',
    appPullStatisticDesc: 'Pull the source appStore statistics trend graph of the App in the past 7 days',
