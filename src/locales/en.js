...
const en = {
  ...
  system: {
    ...
    offShellNoPrompt: 'You do not have permission to take off shell!',
  ...
  promptMessage: {
    ...
    offShellSuccess: 'Take Off shell success!',
    ...
    offShellPrompt: 'This operation will take off shell the app permanently, Do you want to continue?',
    prompt: 'Prompt',
