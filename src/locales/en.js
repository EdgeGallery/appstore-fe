...
const en = {
  ...
  store: {
    ...
    syncTitleTip: 'The application market supports the integration of the third-party multi access edge application orchestration platform (meao). You can synchronize applications to the third-party meao by creating synchronization tasks to facilitate the orchestration and deployment of applications.'
  },
  docs: {
