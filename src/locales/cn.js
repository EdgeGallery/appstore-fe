...
const cn = {
  ...
  common: {
    ...
    bannerWord: '汇聚各行业最前沿的边缘应用',
    bannerWord1: '共享5G智慧互联生活',
    type: '类型',
    video: '视频应用',
    game: '游戏',
  ...
  apppromotion: {
    ...
    appNoticeStatistic: '■ APP通知统计',
    appPushTargetAppstore: '目标仓库',
    appHotIndustryDesc: '热门行业应用下载趋势图',
    appPushStatisticDesc: 'Top5应用推送目标仓库统计图',
    appNoticeStatisticDesc: 'Top5应用推送源仓库统计图',
    appPullStatisticDesc: '近7天拉取应用的源仓库统计趋势图',
    pushChartUnit: '单位：次',
    quarterly1: '第一季度',
    quarterly2: '第二季度',
    quarterly3: '第三季度',
  ...
  appShare: {
    manager: '外部应用仓库管理',
    appstoreManager: '添加、修改和删除可以应用共享的外部仓库。',
